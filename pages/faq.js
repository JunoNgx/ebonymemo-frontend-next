...
These refer to the releases of the game. "And" and "iOS" are hyperlinked to the Google Play Store and Apple App Store, respectively. If you see "oth", it means that the game has at least a release outside of the two aforementioned store fronts, usually Itch.io, web, Steam, Humble Store, or other console releases, which you can find in the game description page. If you see "And" or "iOS" being striken-through, the release has been delisted.

For information on delisted releases, see the question below.

----

**Why are some games delisted?**
...
(As a side note, I am first-hand guilty of this. I cancelled my Apple developer membership out of poor value I got out of it, and that's how my game was delisted on the iOS App Store.)
...
If a game has been delisted on your platform, please reach out to the developer and express your interest. And if that fails, let's just put it out that **piracy** is a potential solution that **I do not advocate**.
...
This website doesn't make any money. I made for my web development portfolio. I pay for the domain and hope the traffic doesn't break the free tier.
...
This website is partially inspired by [Warp Door](http://warpdoor.com/) and [forest ambassador](https://forestambassador.com/) (which is sadly no longer active, but you should be able to find interesting things there still). I just took over-engineering to a whole new level.
